...
class Transaction(models.Model):
    sell = models.ForeignKey('SellOffer', on_delete=models.CASCADE, related_name='transactions', null=True, blank=True)
    buy = models.ForeignKey('BuyOffer', on_delete=models.CASCADE, related_name='transactions', null=True, blank=True)
